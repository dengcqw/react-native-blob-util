...
import com.ReactNativeBlobUtil.videoupload.impl.compute.TXHttpTaskMetrics;
import com.ReactNativeBlobUtil.videoupload.impl.compute.TXOnGetHttpTaskMetrics;
...
public class TVCClient {
    ...
    public TVCClient(Context context, String customKey, String signature, boolean enableResume, boolean enableHttps,
        ...
        updateConfig(customKey, signature, enableResume, enableHttps, iTimeOut, sliceSize, concurrenceSize, resumeController);
    }
...
//        CosXmlService 中设置
    ...
    class MyCosXmlResultListener implements CosXmlResultListener {
        ...
        public void onFail(CosXmlRequest cosXmlRequest, CosXmlClientException qcloudException,
            ...
            if (!isCallback && isQuic) {
                Log.w(TAG, "out of exception,quic failed,retry");
                // quic失败，使用http重新上传
                quicTransToHttpRetry();
            }
        }
